 ...
 * @version $Id: ScriptingCredentialMappingRule.java 1644 2010-07-27 19:31:39Z
 *          sgonzalez $
 */
public class ScriptingCredentialMappingRule extends BaseScriptingMappingRule implements CredentialMappingRule {
	...
	if (joinRule != null) {
	    ...
	    joinParams
		    .add(new ScriptingRuleParameterImpl("selectedCredentials", selectedCredentials, Collection.class));
	    ScriptingRuleEngine sre = new ScriptingRuleEngine();
	    ScriptingRuleExecutionOutcome outcome;
	    try {
	...
	if (validateRule != null) {
	    ...
	    validateParams.add(
		    new ScriptingRuleParameterImpl("transformedCredentials", transformedCredentials, Credential.class));
	    ScriptingRuleEngine sre = new ScriptingRuleEngine();
	    ScriptingRuleExecutionOutcome outcome;
	    try {
